...
public class List extends BaseEntity {
    ...
    public enum Constants {
        ...
        PROC_COLVIR_02("8181839e61e1114d0161e135671c0001"),
        BANKING_BASE_WORK("919191b03a0bbc53013a0bd3e97104c7"),
        BANKING_BASE_WORK_V2("818181b03a0bbc53013a0bd3e97104c7"),
        NO_REMOTE_ACCESS("818182de5414dc32015418f1fc8e07cf"),
        CLIENTIGNOREANL("818181b03ce8a434013cec9c3058513c"),
        MINOR("ff80808134327be9013432b6fe64002c"),
        ...
        YES_V3("ff8080812e7bab80012e7bae4bc6002b"),
        YES_NEED("ff808081304b66e601304b6e0078002b"),
        EXTENDED("ff80818138bd32c90138bd8c05480052"),
        ...
        ALL_REVIEWERS("ff808081307943d6013079eb858e04db"),
        ...
        YES_GIVEN("818182de5414dc32015418f2811407d0"),
        ...
        UDF_WORKTASK_SEVERITY_CRITICAL("818185306560b986016560f94f050001"),
        REQBYCONRTOLLER("ff8081813fd1da8f013fd21cdc160024"),
        REQBYAUTHOR("ff8081813fce5b48013fce5d89180000"),
        KAZAH_NBP("818180a03ef006f7013ef95febb05ba3"),
        SDBUG_PRIORITYBUG_CRITICAL("ff80808134327be9013432b6fdb5002a"),
        SDBUG_PRIORITYBUG_CRITICAL_AFTER_UPDATE("8181817e3a32a713013a32b11748001d"),//Критическая ошибка после обновления
        ...
        UDF_SDDEV_DEVDECISION_ALTERNATE("8181817e361121140136116c1c7b03de"),
        UDF_SDDEV_DEVDECISION_GOOD("8181817e361121140136116c1c5c03dc"), //Учет кастомизации улучшающей функционал
        SD_INLICENSE_YES("402882bb415a1dc901415a68e3ed000c"),
        UDF_SDDEV_CUSTOMTYPE_REPLACE("8181817e3611211401361156b4a402ec"),
        UDF_SDDEV_CUSTOMTYPE_ADD("8181817e3611211401361156b4cd02ed"),
        ESSENTIAL_MAJOR("ff80808134327be9013432b6fe3e002b"),
        ...
        FIRST_CATEGORY_ANALYST("ddb349058520501ce040007f0100482c"), // Аналитик 1 категории (1a)
        NEED_TECH_TESTING_YES("8181817e3ee9fc2e013eea0f7a310140"),//
        WORKTASK_COMPLEXITY_3("402882bb4453af2a014453fb73c74108"),//
        WORKTASK_BUSINESSTRIP_NO("402882bb4453af2a0144540af39b4118"),//
        WORKTASK_LANGUAGES_TECHNICAL("402882bb4453af2a0144540391f34115"),//
        WORKTASK_NEEDNEO_YES("8181817e3ee9fc2e013eea17a4790179"),//
        WORKTASK_NEEDWORKSAMPLES_YES("8181817e3f424a0d013f4253fb3d000e"),//
        WORKTASK_VACANCYPRIORITY_HIGH("8181817e3ee9fc2e013eea4b952a01b1"),//
        WORKTASK_SANCTION_APPROVE("8181817e3eb24971013eb3b670800040"),//
        WORKTASK_REASSIGNCONTROL_MSG_IGNORE("8181818728cf30300128d0e8739e16c6"),//
        RESPONSIBLE_PARTY_SUPPLIER("818182d33920daa3013920dde2200027"),////
        CONDITIONS_ACCEPTED_NO("4028891a567d941f01567e9848c721ab"),////
        CONDITIONS_ACCEPTED_YES("4028891a567d941f01567e9829ea21aa"),////
        RESPONSIBLE_PARTY_CLIENT("818182d33920daa3013920dde2800028"),//
        ...
        BREST_CITY("402882bb4453af2a014453f4f6b140ed"); //
