...
public class InitEntities {
    ...
    private static final String DESCRIPTION_TABLE_PATH = "common/src/main/resources/data/description.json";
    ...
    private static final String USER_JSON_PATH = "common/src/main/resources/data/user.json";
    private static final String USER_SECOND_JSON_PATH = "common/src/main/resources/data/handlerUser.json";
