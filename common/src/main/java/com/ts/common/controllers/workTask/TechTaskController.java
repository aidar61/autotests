...
public class TechTaskController extends BaseController {
    ...
    public TechTaskController(String url, AuthToken authToken) {
        super(url, authToken);
    ...
    public Response create(GeneralTask devTask) {
    ...
    public Map<String, UdfTask> getTaskForSDRequest(String parentNumber) {
        this.response = super.get(getEndpoint(REST, TASK, CREATE, parentNumber, "CAT_TECHTASK"));
