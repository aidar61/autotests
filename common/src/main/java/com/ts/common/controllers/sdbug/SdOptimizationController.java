package com.ts.common.controllers.sdbug;
...
import static com.ts.common.enums.TaskType.SD_BUG;

public class SdOptimizationController extends BaseController {

    private static final TaskType TASK_TYPE = SD_BUG;

    public SdOptimizationController(String url, AuthToken authToken) {
        super(url, authToken);
