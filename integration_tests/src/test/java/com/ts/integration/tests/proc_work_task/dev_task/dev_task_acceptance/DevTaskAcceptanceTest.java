...
public class DevTaskAcceptanceTest extends BaseIntegrationTest {
    ...
    public void taskAcceptance() {
        ...
        var subTasks = response.jsonPath().getList("tasks", com.ts.common.entitites.tasks.Task.class);
        ...
        CommonAssert.assertThat(response).isCorrectSubTaskStatus("CAT_ACCEPTTASK", STATUS_WORKTASK_ASSIGNED);

        var responseTask = apiController.receiveTask(task.getNumber());
        CommonAssert.assertThat(responseTask).isCorrectUdfList(UDF_CDP_ACCEPTANCE_STATUS, UDF_CDP_ACCEPTANCE_STATUS_ACCEPTANCE.id);
    ...
    public void checkCatDevTask() {
        ...
        CommonAssert.assertThat(devTask).isCorrectUdfListCode(UDF_CDP_ACCEPTANCE_STATUS, "ACCEPTED");
    }
}
