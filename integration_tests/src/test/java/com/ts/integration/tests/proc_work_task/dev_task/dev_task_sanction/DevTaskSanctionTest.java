...
public class DevTaskSanctionTest extends BaseIntegrationTest {
    ...
    public void allowKPO() {
        ...
        udf = refreshUdf();
        var userData = new UserData(null, "{\"prgguid\":\"" + UDF_PRGAREA_BNK.id + "\",\"prgcode\":\"BNK\",\"reviewfl\":false,\"reviewmode\":\"NBL\",\"construser\":[],\"subconstruser\":[],\"nearestConstruser\":[],\"nearestSubconstruser\":[],\"allowfl\":\"1\"}");
        ...
        ApiAsserts.assertThat(adviceController.getResponse()).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK).isParseableBody(TaskResponseBody.class).assertTask().isCorrectStatus(STATUS_ADVICE_CLOSED);

        var devTaskResponse = apiController.receiveTask(task.getNumber());
        CommonAssert.assertThat(devTaskResponse).isCorrectReviewMode(UDF_PRGAREA, UDF_PRGAREA_BNK.getId(), "NBL");
    ...
    public void changePrgArea1() {
        ...
        CommonAssert.assertThat(catSanctionTasksResponse).isCorrectSubTasksStatus("CAT_SANCTION", STATUS_ADVICE_AWAIT).isCorrectSubTasksUser("submitterUser", handlerUser.getLogin());
    ...
    public void changePrgArea3() {
        ...
        prgAreas.put(UDF_PRGAREA_CDW, new UserData("{\"longname\":\"Хранилище данных Colvir\",\"parent\":\"\",\"stdFl\":false,\"isdata\":false,\"stdt\":\"0\",\"selectable\":true,\"archive\":false,\"inheritFl\":true,\"reviewfl\":true,\"reviewFl\":false,\"groupfl\":false}", "{\"prgguid\":\"42954D8A847B4E4EA1F2E692BFA232A9\",\"prgcode\":\"CDW\",\"reviewfl\":false,\"allowrequest\":\"8181816c89cef25c018a08c026b44df8\",\"reviewmode\":\"BL\",\"construser\":[],\"subconstruser\":[],\"nearestConstruser\":[],\"nearestSubconstruser\":[],\"allowfl\":\"1\"}"));
        prgAreas.put(UDF_PRGAREA_BNK, new UserData("{\"longname\":\"Основная банковская деятельность\",\"parent\":\"\",\"stdFl\":false,\"isdata\":false,\"stdt\":\"0\",\"selectable\":true,\"archive\":false,\"inheritFl\":true,\"reviewfl\":true,\"reviewFl\":false,\"groupfl\":false}", "{\"prgguid\":\"A4932143EF244F7EBBEFD72D1A9B6493\",\"prgcode\":\"BNK\",\"reviewfl\":false,\"allowfl\":\"1\",\"allowrequest\":\"8181816c89cef25c018a0866491f3eb4\",\"allowuser\":\"818181a81e88c49f011e96ab4bea027f\",\"reviewmode\":\"NBL\",\"construser\":[],\"subconstruser\":[],\"nearestConstruser\":[],\"nearestSubconstruser\":[]}"));
        udf.setUdfMultiList(generateUdfMultiList(UDF_PRGAREA, prgAreas));
        task.refreshUdf(udf);
        devTaskController.performCommonOperation(task, WORKTASK_CHANGEPRGAREA);
        ...
        CommonAssert.assertThat(taskDetailResponse).isCorrectReviewMode(UDF_PRGAREA, UDF_PRGAREA_CDW.id, "BL").isCorrectReviewMode(UDF_PRGAREA, UDF_PRGAREA_BNK.id, "NBL");
    }
}
