...
public class BugTaskConvertToDevTaskTest extends BaseIntegrationTest {
    ...
    public void changeCategory() {
        ...
        task.refreshUdf(udf);
        var date = DateUtils.getCurrentDate(7);
        udf.setUdfDate(generateUdfDate(UDF_WORKTASK_ANALYSISFD, date));
