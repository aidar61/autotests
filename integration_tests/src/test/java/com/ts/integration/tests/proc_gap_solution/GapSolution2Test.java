...
public class GapSolution2Test extends BaseIntegrationTest {
    ...
    public void beforeClass() {
        employee = userController.receiveRandomEmployees(Parents.RYSGAL_BANK).getForUser();
        client = userController.receiveRandomEmployees(Parents.RYSGAL_BANK).getForUser();
