...
public class SdDocBugBaseDynamicTest extends BaseIntegrationTest {
    ...
    public void taskDecline() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, DECLINE);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskReturn() {
        ...
        udf.setUdfUser(generateUdfUser(STDT_HANDLER, SUPPORT_MEMBER));
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, RETURN);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskStart() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, START);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskCloseWoPatch() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, CLOSE_WO_PATCH);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskUndoClose() {
        ...
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, UNDO_CLOSE);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskUndoStart() {
        ...
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, UNDOSTART);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskRequestInfo() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, REQUESTINFO);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskProvideInfo() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, PROVIDEINFO);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskHotFix() {
        ...
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, HOTFIX);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskUndoInPatch() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, UNDOINPATCH);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
    ...
    public void taskClose() {
        ...
        udf = refreshUdf();
        task.refreshUdf(udf);
        sdDocBugController.performCommonOperation(task, CLOSE);
        ApiAsserts
                .assertThat(sdDocBugController.getResponse())
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK)
                .assertTask()
