...
public class SlaBug9Test extends BaseIntegrationTest {
    ...
    @Test(groups = {"PROC_SLABUG", "Regression"},description = "закрыть", dependsOnMethods = "slaBugMsgStart")
