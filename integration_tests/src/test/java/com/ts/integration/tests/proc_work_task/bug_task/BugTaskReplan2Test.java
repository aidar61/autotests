...
public class BugTaskReplan2Test extends BaseIntegrationTest {
    ...
    public void taskChangeTime() {
        ...
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8ebc798d0a16\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8ebc90220a2b\",\"name\":\"Пошаговый план 1\",\"order\":1,\"taskId\":\"818181698b6d8e12018b8ebc6a7909fd\",\"weight\":1,\"budget\":72000,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c2516c220101516c711ff80024\",\"workTypeNorm\":20.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0701] Иное\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
    ...
    public void taskRejectReplan() {
        ...
        task.setDescription(generateString());
        udf = refreshUdf();
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8f3072150b47\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"nameDraft\":\"Предварительный анализ\",\"statusDraft\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8f30ab410b97\",\"name\":\"\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"\",\"nameDraft\":\"Предварительный анализ,\",\"orderDraft\":2,\"weightDraft\":1,\"budgetDraft\":7200,\"statusDraft\":\"NEW\",\"workTypeIdDraft\":\"402881c2516c220101516c711ff80024\",\"workTypeNormDraft\":2.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"[0701] Иное\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8f30839a0b5c\",\"name\":\"Пошаговый план 1\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":72000,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c2516c220101516c711ff80024\",\"workTypeNorm\":20.0,\"nameDraft\":\"Пошаговый план 1\",\"statusDraft\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0701] Иное\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
    ...
    public void taskConfirmReplan() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8f732f510e28\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"nameDraft\":\"Предварительный анализ\",\"statusDraft\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8f7377950e78\",\"name\":\"\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"\",\"nameDraft\":\"Предварительный анализ,\",\"orderDraft\":2,\"weightDraft\":1,\"budgetDraft\":7200,\"statusDraft\":\"DELETE\",\"workTypeIdDraft\":\"402881c2516c220101516c711ff80024\",\"workTypeNormDraft\":2.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"[0701] Иное\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8f73881f0e8b\",\"name\":\"\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"\",\"nameDraft\":\"Предварительный анализ,\",\"orderDraft\":2,\"weightDraft\":1,\"budgetDraft\":7200,\"statusDraft\":\"NEW\",\"workTypeIdDraft\":\"402881c2516c220101516c711ff80024\",\"workTypeNormDraft\":2.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"[0701] Иное\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8f73474e0e3f\",\"name\":\"Пошаговый план 1\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":72000,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c2516c220101516c711ff80024\",\"workTypeNorm\":20.0,\"nameDraft\":\"Пошаговый план 1\",\"statusDraft\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0701] Иное\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
        bugTaskController.performCommonOperation(task, WORKTASK_CONFORMREPLAN);
        ApiAsserts.assertThat(bugTaskController.getResponse()).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK).isParseableBody(TaskResponseBody.class).assertTask().isCorrectStatus(STATUS_WORKTASK_INWORK);

        var response = apiController.receiveTask(task.getNumber());
        CommonAssert.assertThat(response).isCorrectUdfDate(UDF_WORKTASK_PLANTD, step8PlanDate).isCorrectUdfDate(UDF_WORKTASK_AWAITTD, step8PlanDate).isCorrectUdfDouble("Оценка трудоемкости", UDF_WORKTASK_PLANBUDGET, planBudget + 2).isCorrectUdfDouble("Трудоемкость по нормам", UDF_CDP_NORMBUDGET, normBudget).isCorrectUdfDouble("Первоначальная оценка трудоёмкости", UDF_WORKTASK_FIRSTPLANBUDGET, 30);
    }
}