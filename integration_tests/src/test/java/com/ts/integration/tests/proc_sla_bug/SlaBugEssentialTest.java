...
public class SlaBugEssentialTest extends BaseIntegrationTest {
...
//        EMPLOYEE_WATCHER = InitEntities.generateUser("8a8181df75b956e50175d653f6693b37", "aizotov", "Изотов Алексей");
    ...
    public void slaBugCat() {
        ...
        udf.setUdfList(generateUdfList(UDF_SDBUG_PRIORITYBUG, ESSENTIAL_MAJOR));
    ...
    @Test(groups = {"PROC_SLABUG", "Regression"}, description = "Предоставить решение", dependsOnMethods = "start")
    public void hotFix() {
        apiController.updateToken(generateAuthToken(CLIENT_MANAGER));
        udf = refreshUdf();
        task.refreshTask();
