...
public class BugTaskBaseSubmitterTest extends BaseIntegrationTest {
    ...
    public void bugTask() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPLAN,
                "[{\"orderDraft\":1,\"weightDraft\":1,\"budgetDraft\":0,\"planby\":\"budget\",\"deletable\":true,\"statusDraft\":\"NEW\",\"nameDraft\":\"Testing Пошаговый план\",\"workTypeIdDraft\":\"402881c25124956701513912e0f0081d\",\"workTypeNormDraft\":0,\"budgetHrs\":\"\",\"budgetMinutes\":\"\"}]"));
...
//        udf.setFifteenthUdfList(generateUdfList(UDF_WORKTASK_ADDTRSTWATCHINREQST, UDF_WORKTASK_ADDTRSTWATCHINREQST_NO));
    ...
    public void taskClose() {
        ...
        ApiAsserts.assertThat(bugTaskController.getResponse())
                ...
                .isParseableBody(TaskResponseBody.class)
                .assertTask()
                .isCorrectResolution(WILL_NOT_BE_IMPLEMENTED)
