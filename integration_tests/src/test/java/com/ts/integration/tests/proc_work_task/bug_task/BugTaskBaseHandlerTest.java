...
public class BugTaskBaseHandlerTest extends BaseIntegrationTest {
    ...
    private final int planBudget = 25;
    private final int normBudget = 25;
    ...
    public void beforeClass() {
        ...
        MIS_SERVICE2 = bugTaskController.getParent_UDF_MIS_SERVICE(parentPayload).get(1);
    ...
    public void taskComment() {
        ...
        ApiAsserts.assertThat(updateResponse).checkingResponseMessageField("description", comment).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK).isParseableBody(TaskResponseBody.class).assertTask().isCorrectStatus(STATUS_WORKTASK_INWORK);
    }

    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Отклонить ошибку", dependsOnMethods = "taskComment")
    public void taskDecline() {
        ...
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816a8997826e018a40a7df531b82\",\"name\":\"Testing Пошаговый план\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":0,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c25124956701513912e0f0081d\",\"workTypeNorm\":0.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0103] Создание документа - таблица, бизнес\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));

        task.refreshUdf(udf);
        bugTaskController.performCommonOperation(task, BUGDECLINE);
        var updateResponse = bugTaskController.getResponse();
        ApiAsserts.assertThat(updateResponse).checkingResponseMessageField("handlerUser.login", creator.getLogin()).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK).isParseableBody(TaskResponseBody.class).assertTask().isCorrectStatus(STATUS_WORKTASK_DECLINED);
    }
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Принять в работу", dependsOnMethods = "taskReturn")
    public void taskStart2() {
        apiController.updateToken(generateAuthToken(handlerUser));
        task.setHandlerUser(handlerUser);
        task.setDescription(generateString());
        udf = refreshUdf();
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816a8997826e018a44d4d7f61f86\",\"name\":\"Testing Пошаговый план\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":0,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c25124956701513912e0f0081d\",\"workTypeNorm\":0.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0103] Создание документа - таблица, бизнес\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        udf.setUdfUser(generateUdfUser(STDT_HANDLER, handlerUser));
        udf.setUdfDate(generateUdfDate(UDF_WORKTASK_PLANTD, firstPlanTdDate));
        udf.setUdfDouble(generateUdfDouble(UDF_WORKTASK_PLANBUDGET, firstPlanBudget));
        task.refreshUdf(udf);
        ...
        var response = apiController.receiveTask(task.getNumber());
        CommonAssert.assertThat(response).isCorrectUDfDouble(UDF_WORKTASK_FIRSTPLANBUDGET, UDF_WORKTASK_PLANBUDGET);
    }
    ...
    public void taskPostpone() {
        ...
        ApiAsserts.assertThat(bugTaskController.getResponse()).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK).isParseableBody(TaskResponseBody.class).assertTask().isCorrectStatus(STATUS_WORKTASK_POSTPONED);
    }
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Связь с ККПО", dependsOnMethods = "taskStart3")
    public void changePrgArea() {
        ...
        CommonAssert.assertThat(catSanctionResponse).isCorrectTaskStatus(STATUS_ADVICE_AWAIT).isCorrectSubmitterUser(handlerUser.getLogin()).isCorrectUdfList(UDF_PRGAREA, UDF_PRGAREA_BNK.id).isCorrectTaskDescription("Запрос на санкционирование КПО BNK по задаче").isCorrectTaskLink(task.getNumber());
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Перепланировать", dependsOnMethods = "changePrgArea")
    public void taskChangeTime() {
        ...
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816a8997826e018a451503e22640\",\"name\":\"Testing Пошаговый план\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":0,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c25124956701513912e0f0081d\",\"workTypeNorm\":0.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0103] Создание документа - таблица, бизнес\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Согласовать перепланирование", dependsOnMethods = "taskChangeTime")
    public void taskAgreeChangeTime() {
        ...
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816c89cef25c018a4611876c6257\",\"name\":\"Testing Пошаговый план\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":0,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c25124956701513912e0f0081d\",\"workTypeNorm\":0.0,\"nameDraft\":\"Testing Пошаговый план\",\"statusDraft\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0103] Создание документа - таблица, бизнес\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
        bugTaskController.performCommonOperation(task, WORKTASK_CONFORMREPLAN);
        ApiAsserts.assertThat(bugTaskController.getResponse()).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK).isParseableBody(TaskResponseBody.class).assertTask().isCorrectStatus(STATUS_WORKTASK_INWORK);

        var response = apiController.receiveTask(task.getNumber());
        CommonAssert.assertThat(response).isCorrectUdfDouble("Первоначальная оценка трудоёмкости", UDF_WORKTASK_FIRSTPLANBUDGET, firstPlanBudget).isCorrectUdfDouble("Трудоемкость по нормам", UDF_CDP_NORMBUDGET, normBudget).isCorrectUdfDouble("Оценка трудоемкости", UDF_WORKTASK_PLANBUDGET, planBudget).isCorrectUdfInteger("Количество перепланирований", UDF_WORKTASK_REPLAN_N, 1).isCorrectUdfDate(UDF_WORKTASK_AWAITTD, expectedCompletionDate).isCorrectUdfDate(UDF_WORKTASK_PLANTD, expectedCompletionDate);
    }

    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Запретить/Разрешить тиражирование во все ветки: Запретить", dependsOnMethods = "taskStart3")
    public void taskDistToAllBan() {
        ...
        ApiAsserts.assertThat(bugTaskController.getResponse()).checkingResponseMessageField("description", "<br/>Запрещено тиражирование задачи во все ветки. Причина: " + description).isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK);
    }

    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "(Ответственный) Запретить/Разрешить тиражирование во все ветки: Разрешить", dependsOnMethods = "taskDistToAllBan")
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "(Пользователь из поля Конструктор) Запретить/Разрешить тиражирование во все ветки: Разрешить", dependsOnMethods = "taskDistToAllAllowWithHandlerUser")
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Изменить ветку для разработки", dependsOnMethods = "taskDistToAllAllow")
    public void taskChangeBranch() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816c89cef25c018a6f32b56b4b3c\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"8181816c89cef25c018a6f33e9c14c13\",\"name\":\"Пошаговый план 1\",\"order\":1,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":7200,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c2516c220101516c711ff80024\",\"workTypeNorm\":2.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0701] Иное\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"8181816c89cef25c018a6f33e9c14c14\",\"name\":\"Пошаговый план 2\",\"order\":2,\"taskId\":\"" + task.getId() + "\",\"weight\":1,\"budget\":7200,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c2516c220101516c711ff80024\",\"workTypeNorm\":2.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0701] Иное\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Установить функциональную зависимость от другой задачи", dependsOnMethods = "taskChangeBranch")
    ...
    public void changeTestPlanTask() {
        ...
        CommonAssert.assertThat(taskDetail).isCorrectUdfMemo(UDF_WORKTASK_TESTPLAN, description);
    }
    ...
    public void changeLinkedTask() {
        ...
        udf = refreshUdf();
        task.refreshTask();
        var linkedTask = new com.ts.common.entitites.commonEntities.Task.Constants[]{AKKREDITIVES, SERVICE_DESK};
    ...
    public void taskChangeWatcher() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816c89cef25c018a4f111b5d0094\",\"name\":\"Testing Пошаговый план\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Привязать к источнику ошибки", dependsOnMethods = "taskChangeWatcher")
    public void taskBindErrorTask() {
        ...
        var taskDetail = apiController.receiveTask(task.getNumber());
        CommonAssert.assertThat(taskDetail).isCorrectUdfTask(UDF_WORKTASK_ERRORTASK, MODERN_COLVIR_PRODUCT);
    }

    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Создать подзадачу копированием", dependsOnMethods = "taskChangeWatcher")
    ...
    @Test(groups = {"PROC_WORKTASK", "Regression"}, description = "Установить общеполезность", dependsOnMethods = "taskCreateSubtaskWithCopy")
    public void taskChangeGenuse() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"8181816c89cef25c018a4f5c5958084f\",\"name\":\"Testing Пошаговый план\",\"order\":0,\"taskId\":\"" + task.getId() + "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
