package com.ts.integration.tests.proc_sd_help.sdLearn;
...
import static com.ts.common.entitites.commonEntities.List.Constants.ABNATTR;
import static com.ts.common.entitites.commonEntities.List.Constants.RESPONSIBLE_PARTY_SUPPLIER;
import static com.ts.common.entitites.commonEntities.Task.Constants.*;
import static com.ts.common.entitites.commonEntities.Udfs.UdfSd.*;
import static com.ts.common.entitites.commonEntities.Udfs.UdfSd.UDF_SD_TRUSTEDWATCHER;
...
public class SdLearnBaseStaticTest extends BaseIntegrationTest {
    ...
    public void beforeClass() {
        ...
        task = InitEntities.getGeneralTask(TaskType.SD_LEARN, Operations.CAT);
    }
    ...
    @Test(groups = {"PROC_SDHELP", "Regression"}, description = "Задать вопрос (КЛИЕНТ)", dependsOnMethods = "catSdLearn")
    void cliComment() {
        apiController.updateToken(generateAuthToken(CLIENT));
        udf = refreshUdf();
        task.refreshTask();
