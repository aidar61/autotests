...
public class SdBuyBaseDynamicTest extends BaseIntegrationTest {
    ...
    @Test(groups = {"PROC_SDHELP", "Regression"}, description = "Создание CAT_SDBUY (КЛИЕНТ)")
    void catSdBuy() {
    ...
    @Test(groups = {"PROC_SDHELP", "Regression"}, description = "Принять на анализ (МЕНЕДЖЕР КЛИЕНТА)", dependsOnMethods = "catSdBuy")
    void analize() {
