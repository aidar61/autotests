...
import static com.ts.common.enums.Operations.CHANGE_CAT_TO_TEST_TASK;
...
public class AdminJobConvertToTestTaskTest extends BaseIntegrationTest {
    ...
    public void changeConv() {
        ...
        task.refreshUdf(udf);
        workTaskController.performCommonOperation(task, CHANGE_CAT_TO_TEST_TASK);
        ...
        CommonAssert
                ...
                .isCorrectTaskCategory("CAT_TESTTASK");
    }
}
