...
public class BugTaskReplan1Test extends BaseIntegrationTest {
    ...
    public void changePlan() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPLAN,
                "[{\"id\":\"818181698b6d8e12018b8fa5eac21135\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() +
        ...
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8fa5eac21135\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() +
                "\",\"weight\":0,\"budget\":7200,\"progress\":0,\"description\":\"\",\"status\":\"ACTUAL\",\"workTypeId\":\"402881c2516c220101516c711ff80024\",\"workTypeNorm\":2.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"[0701] Иное\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true}]"));
        task.refreshUdf(udf);
...
//                .isCorrectUdfDate(UDF_WORKTASK_PLANFD, awaitDate)
                ...
                .isCorrectUdfDouble("Трудоемкость по нормам", UDF_CDP_NORMBUDGET, normBudget + planBudget);
    }
    ...
    public void taskStart() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8fb7dcfc12c9\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() +
                "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8fb7efd612de\",\"name\":\"Предварительный анализ 2\",\"order\":1,\"taskId\":\"" + task.getId() +
    ...
    public void taskChangeTime() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPLAN, "[{\"id\":\"818181698b6d8e12018b8fb7efd612de\",\"name\":\"Предварительный анализ 2\",\"order\":1,\"taskId\":\"" + task.getId() +
        ...
        udf.setSecondUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8fb7dcfc12c9\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() +
        ...
        CommonAssert
                ...
                .isCorrectUdfDouble("Оценка трудоемкости исполнителем", UDF_WORKTASK_AWAITBUDGET, planBudget + normBudget)
                .isCorrectUdfDouble("Трудоемкость по нормам", UDF_CDP_NORMBUDGET, normBudget + planBudget)
    ...
    public void taskConfirmReplanForm() {
        ...
        var response = bugTaskController
                .receiveContextByOperation(InitEntities.generateOperationID(WORK_TASK, WORKTASK_CONFORMREPLAN).getId(), task.getNumber());
        ApiAsserts.assertThat(response)
                .isCorrectResponseCode(TrackStudioHttpStatusCodes.HTTP_OK);
        CommonAssert
                .assertThat(response)
    ...
    public void taskConfirmReplan() {
        ...
        udf.setUdfMemo(generateUdfMemo(UDF_CDP_STEPPROGRESS, "[{\"id\":\"818181698b6d8e12018b8fb7dcfc12c9\",\"name\":\"Предварительный анализ\",\"order\":0,\"taskId\":\"" + task.getId() +
                "\",\"progress\":0,\"description\":\"\",\"status\":\"DELETE\",\"nameDraft\":\"Предварительный анализ\",\"statusDraft\":\"DELETE\",\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"-\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8fca90cd137b\",\"name\":\"\",\"order\":0,\"taskId\":\"" + task.getId() +
                "\",\"progress\":0,\"description\":\"\",\"status\":\"\",\"nameDraft\":\"Предварительный анализ 3\",\"orderDraft\":2,\"weightDraft\":1,\"budgetDraft\":72000,\"statusDraft\":\"NEW\",\"workTypeIdDraft\":\"402881c2516c220101516c711ff80024\",\"workTypeNormDraft\":20.0,\"hrs\":0,\"deletable\":true,\"actualBudget\":0,\"planby\":\"budget\",\"workTypeAsString\":\"-\",\"workTypeDraftAsString\":\"[0701] Иное\",\"draftChanged\":true},{\"id\":\"818181698b6d8e12018b8fb7efd612de\",\"name\":\"Предварительный анализ 2\",\"order\":1,\"taskId\":\"" + task.getId() +
